...
test.describe('Playwright.dev – Getting Started', () => {
  test('getting started page should contain table of contents', async ({ page }) => {
  ...
  test('should navigate to Page Object Model article', async ({ page }) => {
    const playwrightDev = new PlaywrightDevPage(page);
